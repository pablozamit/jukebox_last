...
4. *(Opcional pero recomendado)* **El instalador de Python**: Descárgalo desde python.org en casa y mételo al pendrive por si el PC del bar no lo tuviera instalado.
5. *(Opcional)* **El instalador de Kodi**: Por si tuvieras que instalarlo de cero.
