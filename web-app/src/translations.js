export const translations = {
  es: {
    ...
    add: "Añadir",
    voteButton: "Votar",
    alreadyVotedNowPlaying: "Ya has votado esta canción.",
    voteNowPlaying: "Votar esta canción.",
    voteDisabledNowPlaying: "No puedes votar esta canción.",
    proposalLimitReached: "Has alcanzado el límite de propuestas.",
    voteLimitReached: "Has alcanzado el límite de votos.",
    ...
    mySongsTab: "Mis canciones",
    favoritesEmpty: "Aún no tienes favoritas. Toca el ♥ en una canción.",
    mySongsEmpty: "No tienes canciones aquí todavía. Propón o vota para verlas.",
    addToFavorites: "Añadir a favoritas",
    removeFromFavorites: "Quitar de favoritas",
    showMoreSongs: "Mostrar más canciones ({count})",
    activityTitle: "Actividad en vivo",
    lastPlayedTitle: "Últimas sonadas",
    activityProposed: "{name} propuso '{title}'",
    activityVoted: "{name} votó '{title}'",
    activityProposedShort: "propuso",
    activityVotedShort: "votó",
  ...
  en: {
    ...
    add: "Add",
    voteButton: "Vote",
    alreadyVotedNowPlaying: "You already voted for this song.",
    voteNowPlaying: "Vote for this song.",
    voteDisabledNowPlaying: "Cannot vote for this song.",
    proposalLimitReached: "You have reached your proposal limit.",
    voteLimitReached: "You have reached your vote limit.",
    ...
    mySongsTab: "My songs",
    favoritesEmpty: "No favorites yet. Tap the ♥ on a song.",
    mySongsEmpty: "No songs here yet. Propose or vote to see them.",
    addToFavorites: "Add to favorites",
    removeFromFavorites: "Remove from favorites",
    showMoreSongs: "Show more songs ({count})",
    activityTitle: "Live activity",
    lastPlayedTitle: "Recently played",
    activityProposed: "{name} proposed '{title}'",
    activityVoted: "{name} voted '{title}'",
    activityProposedShort: "proposed",
    activityVotedShort: "voted",
